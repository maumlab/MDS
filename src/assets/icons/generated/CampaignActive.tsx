...
import Svg from "../../svg";
export const CampaignActive = React.memo<IconProps>(
  ({
    size = IconSize.S,
    fillColor = "gray2",
    viewBox = "0 0 24 24",
    ...
    return (
      ...
      >
        <path
          d="M5.875 3.9L12 12 5.875 3.9zM15.094 13.318c1.708 1.757 1.708 4.607 0 6.364a4.29 4.29 0 01-6.188 0c-1.708-1.757-1.708-4.607 0-6.364a4.29 4.29 0 016.188 0zM18.125 3.9L12 12l6.125-8.1z"
