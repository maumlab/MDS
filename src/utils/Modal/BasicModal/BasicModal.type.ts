 ...
 * @param {string} isResponsiveCloseIconVisible 반응형에서 closeIcon 유무를 위해 사용 (반응형 모바일에서 alert, confirm일 때 closeIcon 비노출), default: true
 */
export type BasicModalProps = {
  title: string;
  size?: ModalSize;
  responsive?: boolean;
  isResponsiveCloseIconVisible?: boolean;
} & ModalProps;
